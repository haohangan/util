...
//		zk.create("/rpc", ni.toJson().getBytes(StandardCharsets.UTF_8), Ids.OPEN_ACL_UNSAFE, CreateMode.PERSISTENT);
		System.out.println("data:" + new String(zk.getData("/rpc", false, null)));
		zk.close();
	}
}
